...
class Service::Trello < Service::Base
  ...
  string :token, placeholder: 'Member token',
                 label: <<-EOT
You should generate token by opening the following URL. Replace DEVELOPER_PUBLIC_KEY with your key.
<br/><br/>
...
<br/><br/>
Grant access to your account by pressing Allow button. Paste the returned token into this field.
EOT
